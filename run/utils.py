...
import binascii
import os
from settings import BASE_DIR,RSAKEYPATH
...
def gimmepw(*args):
    """
    load a password-protected private key from a .pen file with M2Crypto
    :param args:
    :return:
        private passwrod
    """
...
#获取rsa秘钥
rsa = RSA.load_key(RSAKEYPATH,gimmepw)

def decryptMsg(mesg= """<put your iOS encrypted message here>"""):
    """
    rsa解密
    :param mesg:
    :return:
    """
    return rsa.private_decrypt(base64.b64decode(mesg), 1)
